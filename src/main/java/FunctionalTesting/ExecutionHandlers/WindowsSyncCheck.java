...
public class WindowsSyncCheck extends UIAutomation{
    ...
    //Waits for an AutomationElement to load before continuing execution
    ...
    //Checks for the presence of an AutomationElement
    public AutomationElement checkForWindows(ControlType controlType, String title, int numberOfRetries) throws AutomationException {
        AutomationElement element = null;
        Variant.VARIANT.ByValue variant1 = new Variant.VARIANT.ByValue();
        variant1.setValue(22, controlType.getValue());
        Variant.VARIANT.ByValue variant2 = new Variant.VARIANT.ByValue();
