...
public class CustomExcelReader extends XlsxReader {
    ...
    //Returns the contents of a cell given the Excel sheet and cell address
    ...
    //Returns the contents of a cell given the Excel sheet and cell index
    ...
    //Returns the row number of a cell with the inputted string
    ...
    //Returns the column number of a cell with the inputted string
    ...
    //Returns the cell with the inputted string
